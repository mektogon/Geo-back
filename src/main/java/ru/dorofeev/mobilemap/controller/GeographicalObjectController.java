...
public class GeographicalObjectController implements AbstractController<GeographicalObjectDto> {
    ...
    @PutMapping()
    public void uploadEntityAndFile(
